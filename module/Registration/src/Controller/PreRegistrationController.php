...
class PreRegistrationController extends AbstractActionController
{
    ...
    public function savePreRegistrationAction()
    {
        ...
        {   
            ...
            $msge=  "Bienvenue à l'UdM.Votre code d'admission est ".$numDossier.".Connectez vous sur le lien http://AgenlaAcademy.aed-cm.org pour finaliser votre inscription.";
