...
class StdAdmissionController extends AbstractRestfulController
{
    ...
    public function create($data)
    {
        ...
        {   
            ...
            $msge=  urlencode( "Bonjour et bienvenue à l'UdM.Votre code d'admission est ".$numDossier.".Connectez vous sur le lien http://AgenlaAcademy.aed-cm.org pour finaliser votre inscription.");
