...
/**
 * CurrentYearOnlyUeExamsView
 *
 * @ORM\Table(name="currentyearonlyueexamsview", uniqueConstraints={@ORM\UniqueConstraint(name="matricule_UNIQUE", columns={"matricule"})})
 * @ORM\Entity
 */
class CurrentYearOnlyUeExamsView
{
    /**
    * @var integer
    *
