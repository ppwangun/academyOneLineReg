...
class School extends \Application\Entity\School implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\School' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\School' . "\0" . 'code', '' . "\0" . 'Application\\Entity\\School' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\School' . "\0" . 'logo'];
        }
