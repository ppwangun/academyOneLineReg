 ...
 */
class ClassOfStudy extends \Application\Entity\ClassOfStudy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassOfStudy $proxy) {
    ...
    public function setStudyLevel($studyLevel = NULL)
    {
        ...
        return parent::setStudyLevel($studyLevel);
    }
    ...
    public function setIsEndOfCoreCurriculum($isEndOfCoreCurriculum = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsEndOfCoreCurriculum', [$isEndOfCoreCurriculum]);

        return parent::setIsEndOfCoreCurriculum($isEndOfCoreCurriculum);
    }
    ...
    public function getIsEndOfCoreCurriculum()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsEndOfCoreCurriculum', []);

        return parent::getIsEndOfCoreCurriculum();
    }
    ...
    public function setIsEndCycle($isEndCycle = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsEndCycle', [$isEndCycle]);

        return parent::setIsEndCycle($isEndCycle);
    }
    ...
    public function getIsEndCycle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsEndCycle', []);

        return parent::getIsEndCycle();
    }
    ...
    public function setIsEndDegreeTraining($isEndDegreeTraining = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsEndDegreeTraining', [$isEndDegreeTraining]);

        return parent::setIsEndDegreeTraining($isEndDegreeTraining);
    }
    ...
    public function getIsEndDegreeTraining()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsEndDegreeTraining', []);

        return parent::getIsEndDegreeTraining();
    }

    /**
     * {@inheritDoc}
     */
    public function setCycle(\Application\Entity\TrainingCurriculum $cycle = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setDeliberation(\Application\Entity\Deliberation $deliberation = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliberation', [$deliberation]);

        return parent::setDeliberation($deliberation);
    }
     ...
     * {@inheritDoc}
     */
    public function setGrade(\Application\Entity\Grade $grade = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function addAcademicYear(\Application\Entity\AcademicYear $academicYear)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAcademicYear', [$academicYear]);

        return parent::addAcademicYear($academicYear);
    }

    /**
     * {@inheritDoc}
     */
    public function removeAcademicYear(\Application\Entity\AcademicYear $academicYear)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAcademicYear', [$academicYear]);

        return parent::removeAcademicYear($academicYear);
    }
