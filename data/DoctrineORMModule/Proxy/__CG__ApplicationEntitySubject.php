 ...
 */
class Subject extends \Application\Entity\Subject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'subjectCode', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'subjectName', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'poids', '' . "\0" . 'Application\\Entity\\Subject' . "\0" . 'teachingUnit'];
        }
    ...
    public function setSubjectCode($subjectCode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubjectCode', [$subjectCode]);
    ...
    public function getSubjectCode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubjectCode', []);
