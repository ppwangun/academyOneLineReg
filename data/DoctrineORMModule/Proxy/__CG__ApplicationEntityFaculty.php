...
class Faculty extends \Application\Entity\Faculty implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Faculty' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Faculty' . "\0" . 'code', '' . "\0" . 'Application\\Entity\\Faculty' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Faculty' . "\0" . 'createdDate', '' . "\0" . 'Application\\Entity\\Faculty' . "\0" . 'responsable', '' . "\0" . 'Application\\Entity\\Faculty' . "\0" . 'status', '' . "\0" . 'Application\\Entity\\Faculty' . "\0" . 'school'];
        }
