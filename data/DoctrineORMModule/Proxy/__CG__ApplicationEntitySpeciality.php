 ...
 */
class Speciality extends \Application\Entity\Speciality implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Speciality' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Speciality' . "\0" . 'code', '' . "\0" . 'Application\\Entity\\Speciality' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Speciality' . "\0" . 'status', '' . "\0" . 'Application\\Entity\\Speciality' . "\0" . 'fieldOfStudy'];
        }
